...
const array = ['Akshan','Anthass','Ayin','Monu','padikk','Logan','Luca','number','sticker','support','work','photo','Wait','Poli','Sed','Sourav','vibe','Ayye','Ee','gn','Enth','Bgm','Hello','myre','help','Vijay','Rashmika','song','Sry','Line','Aarulle','Ajmal','achodaa','ayin','Aysheri','Ayyo','broken','bye','chattho','cute','Da','Eee','Eee2','engane und','Entha','Enthada','Girls','Good morning','seth','Nope','left','cheyyatte','fear','Ded','etha','poyi','Good night','Hy','ithokke enth','ivan','Kurippe','Kurumb','Love','Mm','naanam','nadakkatte','Ok','paavam','Pattumo','pikachu','Pm','poda','Pova','Save','setth','sho','Shoo','Smile','tag','Udayipp','umma','Vaa','Vannu','yo','ys']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
